 ...
 * Braintrust finder.
 *
 * Braintrust exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - BRAINTRUST_API_KEY   (official API / OAuth token)
 *   - BRAINTRUST_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_BRAINTRUST_APPLY_ENABLED=true. Never submits real money-bearing
