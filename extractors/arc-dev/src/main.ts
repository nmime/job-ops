 ...
 * Arc.dev finder.
 *
 * Arc.dev exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - ARC_DEV_API_KEY   (official API / OAuth token)
 *   - ARC_DEV_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_ARC_DEV_APPLY_ENABLED=true. Never submits real money-bearing
