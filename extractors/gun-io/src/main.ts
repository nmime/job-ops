 ...
 * Gun.io finder.
 *
 * Gun.io exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - GUN_IO_API_KEY   (official API / OAuth token)
 *   - GUN_IO_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_GUN_IO_APPLY_ENABLED=true. Never submits real money-bearing
