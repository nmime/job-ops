 ...
 * Toptal finder.
 *
 * Toptal exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - TOPTAL_API_KEY   (official API / OAuth token)
 *   - TOPTAL_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_TOPTAL_APPLY_ENABLED=true. Never submits real money-bearing
