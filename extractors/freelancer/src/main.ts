...
/**
 * Freelancer.com finder.
 *
 * Freelancer.com exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - FREELANCER_API_KEY   (official API / OAuth token)
 *   - FREELANCER_COOKIE    (authenticated session cookie)
 *
...
/**
 * Freelancer.com apply adapter.
 *
 * GUARDED: ctx.dryRun is forced true by the orchestrator unless
 * JOBOPS_FREELANCE_FREELANCER_APPLY_ENABLED=true. Never submits real money-bearing
