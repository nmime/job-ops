 ...
 * FlexJobs finder.
 *
 * FlexJobs exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - FLEXJOBS_API_KEY   (official API / OAuth token)
 *   - FLEXJOBS_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_FLEXJOBS_APPLY_ENABLED=true. Never submits real money-bearing
