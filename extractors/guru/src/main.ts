 ...
 * Guru finder.
 *
 * Guru exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - GURU_API_KEY   (official API / OAuth token)
 *   - GURU_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_GURU_APPLY_ENABLED=true. Never submits real money-bearing
