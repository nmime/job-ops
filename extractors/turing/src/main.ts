 ...
 * Turing finder.
 *
 * Turing exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - TURING_API_KEY   (official API / OAuth token)
 *   - TURING_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_TURING_APPLY_ENABLED=true. Never submits real money-bearing
