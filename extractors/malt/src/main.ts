 ...
 * Malt finder.
 *
 * Malt exposes no credential-free public listing API. A real finder needs
 * one of:
 *   - MALT_API_KEY   (official API / OAuth token)
 *   - MALT_COOKIE    (authenticated session cookie)
 *
 ...
 * JOBOPS_FREELANCE_MALT_APPLY_ENABLED=true. Never submits real money-bearing
